...
public:
    ...
    void setupUi(QDialog *DisplayOptionsDlg)
    {
        ...
        DisplayOptionsDlg->resize(493, 461);
        ...
        pageColorAndMatOptions->setGeometry(QRect(0, 0, 475, 304));
        ...
        doubleSidedCheckBox->setObjectName(QStringLiteral("doubleSidedCheckBox"));
        ...
        pageSFOptions->setGeometry(QRect(0, 0, 475, 304));
        ...
        pageLabelsOptions->setGeometry(QRect(0, 0, 475, 304));
        ...
        pageOtherOptions->setGeometry(QRect(0, 0, 475, 304));
        ...
        drawRoundedPointsCheckBox->setObjectName(QStringLiteral("drawRoundedPointsCheckBox"));
    ...
    void retranslateUi(QDialog *DisplayOptionsDlg)
    {
        ...
        doubleSidedCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "<html><head/><body><p>Whether to use a double-sided light model or not</p><p>(if disabled, triangles will appear black when looked from behind)</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        doubleSidedCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "double-sided", Q_NULLPTR));
        ...
        drawRoundedPointsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Draw rounded points (slower)", Q_NULLPTR));
