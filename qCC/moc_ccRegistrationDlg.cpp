...
#include "../../CloudCompare-master/qCC/ccRegistrationDlg.h"
...
struct qt_meta_stringdata_ccRegistrationDlg_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ccRegistrationDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ccRegistrationDlg_t qt_meta_stringdata_ccRegistrationDlg = {
    {
QT_MOC_LITERAL(0, 0, 17), // "ccRegistrationDlg"
QT_MOC_LITERAL(1, 18, 16), // "swapModelAndData"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ccRegistrationDlg\0swapModelAndData\0"
};
...
const QMetaObject ccRegistrationDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccRegistrationDlg.data,
      qt_meta_data_ccRegistrationDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccRegistrationDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccRegistrationDlg.stringdata0))
