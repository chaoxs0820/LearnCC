...
public:
    ...
    void retranslateUi(QDialog *UnrollDialog)
    {
        ...
        comboBoxUnrollShapeType->insertItems(0, QStringList()
         ...
         << QApplication::translate("UnrollDialog", "Straightened cone", Q_NULLPTR)
        );
...
#ifndef QT_NO_TOOLTIP
        angleDoubleSpinBox->setToolTip(QApplication::translate("UnrollDialog", "Cone angle (0-180\302\260)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        radiusDoubleSpinBox->setToolTip(QApplication::translate("UnrollDialog", "Cylinder (or cone base) radius", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        exportDeviationSFCheckBox->setToolTip(QApplication::translate("UnrollDialog", "Deviation from the theoretical shape (i.e. cone or cylinder)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        exportDeviationSFCheckBox->setText(QApplication::translate("UnrollDialog", "Export deviation scalar field", Q_NULLPTR));
    } // retranslateUi
