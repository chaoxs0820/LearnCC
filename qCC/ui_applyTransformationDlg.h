...
public:
    ...
    void setupUi(QDialog *ApplyTransformationDialog)
    {
        ...
        ApplyTransformationDialog->resize(516, 370);
...
"--> assuming an initial position of (0,0)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fromDipDipDirToolButton->setText(QApplication::translate("ApplyTransformationDialog", "dip / dip direction", Q_NULLPTR));
