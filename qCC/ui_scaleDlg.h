...
public:
    ...
    void setupUi(QDialog *ScaleDialog)
    {
        ...
        fxSpinBox->setMinimum(-1e+6);
        fxSpinBox->setMaximum(1e+6);
        ...
        fySpinBox->setMinimum(-1e+6);
        fySpinBox->setMaximum(1e+6);
        ...
        fzSpinBox->setMinimum(-1e+6);
        fzSpinBox->setMaximum(1e+6);
    ...
    {
        ScaleDialog->setWindowTitle(QApplication::translate("ScaleDialog", "Scale / multiply", Q_NULLPTR));
        label1->setText(QApplication::translate("ScaleDialog", "Scale(x)", Q_NULLPTR));
        label2->setText(QApplication::translate("ScaleDialog", "Scale(y)", Q_NULLPTR));
        label3->setText(QApplication::translate("ScaleDialog", "Scale(z)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        sameForAllCheckBox->setToolTip(QApplication::translate("ScaleDialog", "Same scale for all dimensions", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        sameForAllCheckBox->setText(QApplication::translate("ScaleDialog", "Same scale for all dimensions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        keepInPlaceCheckBox->setToolTip(QApplication::translate("ScaleDialog", "Whether the cloud (center) should stay at the same place or not (i.e. coordinates are multiplied directly)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        keepInPlaceCheckBox->setText(QApplication::translate("ScaleDialog", "Keep entity in place", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rescaleGlobalShiftCheckBox->setToolTip(QApplication::translate("ScaleDialog", "To apply the same scale(s) to the 'Global Shift' as well", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rescaleGlobalShiftCheckBox->setText(QApplication::translate("ScaleDialog", "Rescale Global shift", Q_NULLPTR));
    } // retranslateUi
