...
#include "../../CloudCompare-master/qCC/ccColorGradientDlg.h"
...
QT_MOC_LITERAL(1, 19, 16), // "changeFirstColor"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 17) // "changeSecondColor"

    },
    "ccColorGradientDlg\0changeFirstColor\0"
    "\0changeSecondColor"
};
...
void ccColorGradientDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ccColorGradientDlg *_t = static_cast<ccColorGradientDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeFirstColor(); break;
        case 1: _t->changeSecondColor(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ccColorGradientDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccColorGradientDlg.data,
      qt_meta_data_ccColorGradientDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccColorGradientDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccColorGradientDlg.stringdata0))
        return static_cast<void*>(const_cast< ccColorGradientDlg*>(this));
    if (!strcmp(_clname, "Ui::ColorGradientDialog"))
        return static_cast< Ui::ColorGradientDialog*>(const_cast< ccColorGradientDlg*>(this));
