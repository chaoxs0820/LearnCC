...
#include "../../CloudCompare-master/qCC/ccPrimitiveFactoryDlg.h"
...
struct qt_meta_stringdata_ccPrimitiveFactoryDlg_t {
    QByteArrayData data[3];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ccPrimitiveFactoryDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ccPrimitiveFactoryDlg_t qt_meta_stringdata_ccPrimitiveFactoryDlg = {
    {
QT_MOC_LITERAL(0, 0, 21), // "ccPrimitiveFactoryDlg"
QT_MOC_LITERAL(1, 22, 15), // "createPrimitive"
QT_MOC_LITERAL(2, 38, 0) // ""

    },
    "ccPrimitiveFactoryDlg\0createPrimitive\0"
    ""
};
...
const QMetaObject ccPrimitiveFactoryDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccPrimitiveFactoryDlg.data,
      qt_meta_data_ccPrimitiveFactoryDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccPrimitiveFactoryDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccPrimitiveFactoryDlg.stringdata0))
