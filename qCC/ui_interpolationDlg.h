...
public:
    ...
    {
        InterpolationDlg->setWindowTitle(QApplication::translate("InterpolationDlg", "Interpolation", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("InterpolationDlg", "Neighbors extraction", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radiusDoubleSpinBox->setToolTip(QApplication::translate("InterpolationDlg", "Radius of the sphere inside which neighbors will be extracted", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        radiusRadioButton->setToolTip(QApplication::translate("InterpolationDlg", "Extracts the neighbors inside a sphere", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radiusRadioButton->setText(QApplication::translate("InterpolationDlg", "Radius (Sphere)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        nnRadioButton->setToolTip(QApplication::translate("InterpolationDlg", "Use only the nearest neighbor (fast)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        nnRadioButton->setText(QApplication::translate("InterpolationDlg", "Nearest neighbor", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        knnRadioButton->setToolTip(QApplication::translate("InterpolationDlg", "Use the 'k' nearest neighbors\n"
"(faster than 'radius' based search, but more approximate)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        knnRadioButton->setText(QApplication::translate("InterpolationDlg", "Nearest neighbors", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        knnSpinBox->setToolTip(QApplication::translate("InterpolationDlg", "Number of neighbors to extract", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        algoGroupBox->setTitle(QApplication::translate("InterpolationDlg", "Interpolation algorithm", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        medianRadioButton->setToolTip(QApplication::translate("InterpolationDlg", "Keep the median of the neighbors SF values", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        medianRadioButton->setText(QApplication::translate("InterpolationDlg", "Median", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        averageRadioButton->setToolTip(QApplication::translate("InterpolationDlg", "Keep the average of the neighbors SF values", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        averageRadioButton->setText(QApplication::translate("InterpolationDlg", "Average", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"(the weights will follow a Normal distribution)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        normalDistribRadioButton->setText(QApplication::translate("InterpolationDlg", "Normal distribution", Q_NULLPTR));
        label->setText(QApplication::translate("InterpolationDlg", "sigma", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        kernelDoubleSpinBox->setToolTip(QApplication::translate("InterpolationDlg", "Kernel of the Normal distribution", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
