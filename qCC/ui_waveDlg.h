...
public:
    ...
    void retranslateUi(QDialog *WaveDialog)
    {
        ...
        pointPickingToolButton->setToolTip(QApplication::translate("WaveDialog", "Pick a 3D point (click again to cancel)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        logScaleCheckBox->setText(QApplication::translate("WaveDialog", "log scale", Q_NULLPTR));
        fixedAmplitudeCheckBox->setText(QApplication::translate("WaveDialog", "fixed amplitude", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        saveWaveToolButton->setToolTip(QApplication::translate("WaveDialog", "Export wave as CSV file", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
