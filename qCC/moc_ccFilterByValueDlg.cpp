...
#include "../../CloudCompare-master/qCC/ccFilterByValueDlg.h"
...
QT_MOC_LITERAL(1, 19, 8), // "onExport"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7) // "onSplit"

    },
    "ccFilterByValueDlg\0onExport\0\0onSplit"
};
...
void ccFilterByValueDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ccFilterByValueDlg *_t = static_cast<ccFilterByValueDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onExport(); break;
