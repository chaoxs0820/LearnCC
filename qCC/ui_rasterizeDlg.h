...
public:
    ...
    void setupUi(QDialog *RasterizeToolDialog)
    {
        ...
        RasterizeToolDialog->resize(1000, 905);
        ...
        gridStepDoubleSpinBox->setMinimum(1e-5);
...
"replaced by the cell's average height!", Q_NULLPTR));
        ...
        projectContoursOnAltCheckBox->setText(QApplication::translate("RasterizeToolDialog", "project contours on the altitude layer", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        label_19->setText(QApplication::translate("RasterizeToolDialog", "Volume", Q_NULLPTR));
        volumeLabel->setText(QApplication::translate("RasterizeToolDialog", "0", Q_NULLPTR));
        label_20->setText(QApplication::translate("RasterizeToolDialog", "Non empty cells", Q_NULLPTR));
        filledCellsPercentageLabel->setText(QApplication::translate("RasterizeToolDialog", "0%", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(volumeTab), QApplication::translate("RasterizeToolDialog", "Volume", Q_NULLPTR));
    } // retranslateUi
