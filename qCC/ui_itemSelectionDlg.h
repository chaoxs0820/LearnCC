...
public:
    ...
    {
        ItemSelectionDlg->setWindowTitle(QApplication::translate("ItemSelectionDlg", "Selection", Q_NULLPTR));
        label->setText(QApplication::translate("ItemSelectionDlg", "Please select one %1:", Q_NULLPTR));
    } // retranslateUi
