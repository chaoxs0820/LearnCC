...
#include "../../CloudCompare-master/qCC/ccInterpolationDlg.h"
...
QT_MOC_LITERAL(1, 19, 15), // "onRadiusUpdated"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ccInterpolationDlg\0onRadiusUpdated\0"
};
...
void ccInterpolationDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ccInterpolationDlg *_t = static_cast<ccInterpolationDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onRadiusUpdated((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject ccInterpolationDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccInterpolationDlg.data,
      qt_meta_data_ccInterpolationDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccInterpolationDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccInterpolationDlg.stringdata0))
        return static_cast<void*>(const_cast< ccInterpolationDlg*>(this));
    if (!strcmp(_clname, "Ui::InterpolationDlg"))
        return static_cast< Ui::InterpolationDlg*>(const_cast< ccInterpolationDlg*>(this));
