...
public:
    ...
    {
        DipDirTransformationDialog->setWindowTitle(QApplication::translate("DipDirTransformationDialog", "Dip / dip dir. transformation", Q_NULLPTR));
        label->setText(QApplication::translate("DipDirTransformationDialog", "Dip", Q_NULLPTR));
        dipDoubleSpinBox->setSuffix(QApplication::translate("DipDirTransformationDialog", " deg.", Q_NULLPTR));
        label_2->setText(QApplication::translate("DipDirTransformationDialog", "Dip direction", Q_NULLPTR));
        dipDirDoubleSpinBox->setSuffix(QApplication::translate("DipDirTransformationDialog", " deg.", Q_NULLPTR));
        rotateAboutCenterCheckBox->setText(QApplication::translate("DipDirTransformationDialog", "rotate about selection center", Q_NULLPTR));
    } // retranslateUi
