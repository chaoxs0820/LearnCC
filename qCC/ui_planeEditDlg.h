...
public:
    ...
    {
        PlaneEditDlg->setWindowTitle(QApplication::translate("PlaneEditDlg", "Plane properties", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("PlaneEditDlg", "Orientation", Q_NULLPTR));
        dipDoubleSpinBox->setSuffix(QApplication::translate("PlaneEditDlg", " deg.", Q_NULLPTR));
        label_3->setText(QApplication::translate("PlaneEditDlg", "dip", Q_NULLPTR));
        label_4->setText(QApplication::translate("PlaneEditDlg", "dip direction", Q_NULLPTR));
        dipDirDoubleSpinBox->setSuffix(QApplication::translate("PlaneEditDlg", " deg.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        upwardCheckBox->setToolTip(QApplication::translate("PlaneEditDlg", "Whether the plane normal should point upward (Z+) or backward (Z-)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        upwardCheckBox->setText(QApplication::translate("PlaneEditDlg", "upward", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("PlaneEditDlg", "Dimensions", Q_NULLPTR));
        label->setText(QApplication::translate("PlaneEditDlg", "width", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        wDoubleSpinBox->setToolTip(QApplication::translate("PlaneEditDlg", "Plane width", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("PlaneEditDlg", "height", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        hDoubleSpinBox->setToolTip(QApplication::translate("PlaneEditDlg", "Plane height", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        groupBox_3->setTitle(QApplication::translate("PlaneEditDlg", "Center", Q_NULLPTR));
        cxAxisDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "X:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pickCenterToolButton->setToolTip(QApplication::translate("PlaneEditDlg", "Pick the plane center (click again to cancel)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        cyAxisDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "Y:", Q_NULLPTR));
        czAxisDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "Z:", Q_NULLPTR));
    } // retranslateUi
