...
public:
    ...
    void setupUi(QDialog *RegistrationDialog)
    {
        ...
        RegistrationDialog->resize(386, 427);
    ...
    void retranslateUi(QDialog *RegistrationDialog)
    {
        ...
        label_10->setToolTip(QApplication::translate("RegistrationDialog", "'data' entity", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_10->setText(QApplication::translate("RegistrationDialog", "aligned", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        dataLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>entity to align (will be displaced)</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        label_9->setToolTip(QApplication::translate("RegistrationDialog", "'model' entity", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("RegistrationDialog", "reference", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        modelLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>reference entity (won't move)</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
